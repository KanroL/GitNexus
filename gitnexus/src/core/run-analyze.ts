...
interface AnalyzeProfileCounters {
  ...
  scopePartialUnmatchedAffectedFiles?: readonly string[];
...
export async function runFullAnalysis(
  ...
  const partialScopeResolutionStats = {
    ...
    scopeFinalizePatchDisabledReason: undefined as string | undefined,
    ...
    if (isAnalyzeProfilingEnabled()) {
      ...
      const profileLines = formatAnalyzeProfileLog(
        ...
        },
        {
          ...
          scopePartialRawAffectedFiles: pipelineResult.scopeStats?.partialRawAffectedFiles ?? 0,
          scopePartialMatchedAffectedFiles: pipelineResult.scopeStats?.partialMatchedAffectedFiles ?? 0,
          scopePartialUnmatchedAffectedFiles: pipelineResult.scopeStats?.partialUnmatchedAffectedFiles,
          scopeFinalizePatchedFiles: pipelineResult.scopeStats?.finalizePatchedFiles ?? 0,
